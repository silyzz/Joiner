...
MONEY_THRESHOLD = (15.,9999.0) # in millions from, to / в миллионах от, до (example: 1.5 = 1.5m, 0.5 = 500k)
...
PLAYER_THRESHOLD = 8 # число / number
...
IGNORE_LIST = ["La Cucaracha", "Pot Hotspot","Perrito Burrito"] # ignore list, список игнора
...
FILTER_BY_NAME = False, ["Dragon canelonni", "La Grande Combinasion"] # filter by name, фильтр по имени
...
WEBSOCKET_PORT = 1488 # websocket port for data transfer in roblox
