...
MONEY_THRESHOLD = (20.,9999.0) # in millions from, to / в миллионах от, до (example: 1.5 = 1.5m, 0.5 = 500k)
...
IGNORE_LIST = ["La Cucaracha", "Pot Hotspot","Perrito Burrito", "Quesadilla Crocodila"] # ignore list, список игнора
